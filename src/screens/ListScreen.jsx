  ...
  return (
    <div className="screen">
      <div className="screen-header" style={{ paddingTop: 24 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
          ...
          {checkedCount > 0 && (
            <button
              onClick={resetList}
              style={{ background: 'none', border: 'none', fontSize: 12, color: 'var(--text-muted)', cursor: 'pointer', fontFamily: 'var(--font-sans)', marginBottom: 4 }}
            >
              Reset afvinkjes
            </button>
          )}
      ...
      <div className="stats-bar">
        ...
        <div className="stat-item">
          <div className="stat-value" style={{ color: 'var(--bonus-text)' }}>{bonusItems}</div>
          <div className="stat-label">Bonusdeals</div>
        </div>
        {plan.estimatedCost && (
          <div className="stat-item">
            <div className="stat-value">€{plan.estimatedCost.toFixed(0)}</div>
            <div className="stat-label">Geschat</div>
          </div>
        )}
        <div className="stat-item">
          <div className="stat-value" style={{ color: 'var(--green)' }}>{checkedCount}</div>
          <div className="stat-label">Afgevinkt</div>
        </div>
      </div>
